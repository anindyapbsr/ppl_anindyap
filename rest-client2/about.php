...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2>About NewsAPI</h2>
                <p>This is a news aggregation website that uses the NewsAPI service to bring you the latest technology
                    news from around the world. Our platform provides up-to-date news articles from various reliable
                    sources.</p>
                <h3>Features</h3>
                <ul>
                    <li>Latest technology news from top sources</li>
