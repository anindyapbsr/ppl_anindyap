...
function runTests() {
    $apiKeyValid = "b06d85f5e73047149a829b7982190b61";
    ...
    try {
        ...
        echo "[WB_API_001] Connection Test: PASS ✅ (Koneksi berhasil dengan API key valid)\n";
    } catch (Exception $e) {
        echo "[WB_API_001] Connection Test: FAIL ❌ - {$e->getMessage()}\n";
    }
    ...
    try {
        ...
        echo "[WBT_API_002] Invalid Key Handling: PASS ✅ (berita tetap muncul)\n";
    } catch (Exception $e) {
        echo "[WBT_API_002] Invalid Key Handling: FAIL ❌ - (Eror, Apikey tidak valid)\n";
    }
    ...
    try {
        ...
        echo "[WB_API_003] JSON Structure Validation: PASS ✅ (Struktur artikel lengkap)\n";
    } catch (Exception $e) {
        echo "[WB_API_003] JSON Structure Validation: FAIL ❌ - {$e->getMessage()}\n";
    }

    /**
     * TEST 4: Artikel Tidak Kosong
    ...
    try {
        ...
        if (!empty($data['articles'])) {
            echo "[WB_API_004] Article Count Test: PASS ✅ (".count($data['articles'])." artikel ditemukan)\n";
        } else {
            echo "[WB_API_004] Article Count Test: FAIL ❌ (Tidak ada artikel dikembalikan)\n";
        }
    } catch (Exception $e) {
        echo "[WB_API_004] Article Count Test: FAIL ❌ - {$e->getMessage()}\n";
    }
